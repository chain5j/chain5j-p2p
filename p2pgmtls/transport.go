...
func New(cert *gmtls.Certificate, caRoots [][]byte) (*Transport, error) {
...
func (t *Transport) SecureInbound(ctx context.Context, insecure net.Conn) (sec.SecureConn, error) {
	...
	cs, err := t.handshake(ctx, gmtls.Server(insecure, config), keyCh)
	if err != nil {
		insecure.Close()
	}
	return cs, err
...
func (t *Transport) handshake(ctx context.Context, tlsConn *gmtls.Conn, keyCh <-chan ci.PubKey) (sec.SecureConn, error) {
...
func (t *Transport) SecureOutbound(ctx context.Context, insecure net.Conn, p peer.ID) (sec.SecureConn, error) {
	...
	tlsConn := gmtls.Client(insecure, config)
...
// setupConn ...
func (t *Transport) setupConn(tlsConn *gmtls.Conn, remotePubKey ci.PubKey) (sec.SecureConn, error) {
